package com.ticcorp.retrofittest2.core;
...
import com.ticcorp.retrofittest2.StaticInfo;
...
import com.ticcorp.retrofittest2.module.SQLiteAccessModule;
import com.ticcorp.retrofittest2.retrofit2Interface.LoginInterface;
...
public class LoginController {
    ...
    public boolean requestLogin(final Context context, String userId, String name, String platform) {
        ...
        retrofit = new Retrofit.Builder().baseUrl(StaticInfo.retrofittest_BASE_URL).addConverterFactory(GsonConverterFactory.create()).build();
